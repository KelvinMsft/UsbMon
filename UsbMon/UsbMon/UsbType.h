...
#define CHANNEL_DUMP_RANGE_RELATED			4
#define CHANNEL_DUMP_LINK_COL_RELATED		8
#define CHANNEL_DUMP_ALL  CHANNEL_DUMP_ATTRIBUTE_RELATED | CHANNEL_DUMP_REPORT_REALTED | CHANNEL_DUMP_RANGE_RELATED | CHANNEL_DUMP_LINK_COL_RELATED
